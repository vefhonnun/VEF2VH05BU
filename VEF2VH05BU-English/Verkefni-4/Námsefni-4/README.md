...
source: [W3School Animation](https://www.w3schools.com/cssref/css3_pr_animation.asp)

---

### Accessibility, Something to Consider

Even though movement on a website can create interest and help users, it is always important to find a balance and avoid too much visual stimulus on the screen. Flashing ads or aggressive visuals can distract people.

It is now possible to control whether animation is enabled in browsers through the computer's user settings. The CSS standard supports this, similar to color themes and screen sizes, with an @media rule called **` @media (prefers-reduced-motion: reduce) {...} `**. In the PICO CSS framework, this rule is located near the bottom of the code.

In Windows 11, you can choose whether animation is enabled or not.

![Win-11](Accessibility-VisualEffects.png)

See more at: https://web.dev/articles/prefers-reduced-motion
