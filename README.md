...
| --- | --- | --- | --- | --- | 
| 1 | Vinnurammi (_framework_) | Grid skipulag | CSS variables | Litaþema | 
| 2 | Töflur RWD | Form | Form validation | Complex selectors |
| 3 | Drop down menu | Accordion menu | Pop up menu | **Stöðumat** |  
